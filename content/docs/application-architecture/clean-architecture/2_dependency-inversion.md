...
Web / UI ───────────┐      Controllers ─────────┐
Database ───────────┼────▶ Gateways ────────────┼──────────▶ Application Services ───▶ Domain Entities
External Systems ───┘      Presenters ──────────┘
```
...
Web Controller ──────┐
CLI / Batch ─────────┼────────▶ Input Port ─────────▶ Use Case ─────────▶ Output Port ◀────┬──── Persistence Adapter
Test ────────────────┘          SendMoneyUseCase      SendMoneyService    LoadAccountPort   ├──── Message Adapter
