...
AccountController ────────────▶ SendMoneyUseCase ─────────────────▶ SendMoneyService ─────────────────▶ LoadAccountPort ───────────────────▶ AccountPersistenceAdapter
        │                                                                 │                                                                       │
        └────────────────────────────── uses ─────────────────────────────┼──────────────────────────── uses ───────────────────────────────────┘
                                                                          ▼
                                                                       Account
...
AccountController ────────────▶ <<Interface>>
        ...
        │                              │                                             │                          │                         implements
        ▼                              └────────────────────── uses ─────────────┼────────── uses ────────────┘                                ▼
Web Model                                                                        ▼                                                    Persistence Model
account.adapter.in.web                                                           Account                                              account.adapter.out.persistence
                                                                            account.domain
```
...
SendMoneyRequest ─────────────▶ AccountController ─────┬─ map ────▶ SendMoneyCommand ─────────┐
                                                        │                                      │
                                                        └──────────▶ SendMoneyUseCase ─────────┼────────────▶ SendMoneyService ─────────▶ UpdateAccountStatePort ◀──────── AccountPersistenceAdapter
                                                                                               │                         │                                             implements
                                                                                               │                         └────────────▶ AccountStateCommand ─────────▶ AccountJpaEntity
```
...
```text
        ...
        ┌──────────────────────────┼──────────────────────────┬──────────────────────────┬──────────────────────────┐
        │                          │                          │                          │                          │
Web Model                 SendMoneyUseCase        AccountPersistenceAdapter       Persistence Model              Account
account.adapter.in.web    account.application     account.adapter.out.persistence account.adapter.out.persistence account.domain
```
