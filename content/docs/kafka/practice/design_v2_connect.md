...
> 토픽 네이밍은 [3. Topic 설계](../concept/3_topic_design.md), 메시지 포맷은 [5. Message Format 설계](../concept/5_message_format.md) 참조.
...
> JVM 환경 전제 (non-JVM 서비스가 있다면 [5. Message Format 설계](../concept/5_message_format.md) 에서 재검토 필요).
